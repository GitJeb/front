...
/***/ (function(module, exports, __webpack_require__) {
	...
	var uploadEvents = __webpack_require__(12);
	var uploadUi = __webpack_require__(14);
	...
	$(function () {
	  ...
	  var showUpdateForm = function showUpdateForm(event) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// Show Modal
	var onModal = function onModal(event) {
	  ui.showModal(event.target.id);
	};

	// Register
	var onRegistration = function onRegistration(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signUp(data).then(ui.signUpSuccess).catch(ui.signUpFail);
	};
	...
	var onSignIn = function onSignIn(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.signIn(data).then(ui.signInSuccess).catch(ui.signInFail);
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.changePassword(data).then(ui.changePassSuccess).catch(ui.changePassFail);
	};

	// Sign Out
	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  api.signOut().then(ui.signOutSuccess).catch(ui.signOutFail);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// Auth Modal Controls
	var showModal = function showModal(buttonId) {
	  ...
	  };var targetForm = $(buttonRoute[buttonId].formClass);
	...
	var signOutFail = function signOutFail() {
	  clearForms();
	  $('#message').html('Error on sign out. Please try again.');
	};

	var changePassSuccess = function changePassSuccess() {
	  clearForms();
	  $('#message').html('Changed password successfully');
	  $('.modal').modal('hide');
	};

	var changePassFail = function changePassFail() {
	  clearForms();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var uploadApi = __webpack_require__(13);
	var uploadUi = __webpack_require__(14);

	var createUploadMultiPart = function createUploadMultiPart(event) {
	  event.preventDefault();

	  // const data = getFormFields(event.target)
	  var data = new FormData(event.target);

	  uploadApi.createMulti(data).then(uploadUi.success).then(onShowGallery).catch(uploadUi.error);
	  this.reset();
	  return false;
	};

	// Show all images uploaded
	var onShowIndex = function onShowIndex() {
	  uploadApi.indexAll().then(uploadUi.indexAllSuccess).catch(uploadUi.indexAllFail);
	};

	var onShowGallery = function onShowGallery() {
	  uploadApi.indexAll()
	  // pageShowSuccess/ Fail --> ShowGallery Sucess/Fail
	  .then(uploadUi.ShowGallerySuccess).catch(uploadUi.ShowGalleryFail);
	};

	module.exports = {
	  createUploadMultiPart: createUploadMultiPart,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createMulti = function createMulti(data) {
	  return $.ajax({
	...
	var indexAll = function indexAll() {
	  return $.ajax({
	    url: config.apiOrigin + '/uploads/',
	    method: 'GET',
	    contentType: false,
	...
	var deleteUpload = function deleteUpload(id) {
	  return $.ajax({
	...
	var updateUpload = function updateUpload(id, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/uploads/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var uploadApi = __webpack_require__(13);
	var indexView = __webpack_require__(15);
	var pageShow = __webpack_require__(38);
	...
	var onUpdate = function onUpdate(event) {
	  ...
	  var data = getFormFields(event.target);
	  uploadApi.updateUpload(itemId, data).then(updateUploadSuccess).catch(updateUploadFail);
	};

	var onDelete = function onDelete(data) {
	  var itemId = $(event.target).attr('data-id');
	  uploadApi.deleteUpload(itemId).then(deleteUploadSuccess).catch(deleteUploadFail);
	};

	var indexAllSuccess = function indexAllSuccess(data) {
	  $('#photo-grid').html(indexView({ uploads: data.uploads }));
	  activateLink('.showIndex');
	};

	var indexAllFail = function indexAllFail() {
	  $('#message').html('Gallery Error!');
	};

	var deleteUploadSuccess = function deleteUploadSuccess() {
	  $('#message').html('upload successfully deleted!');

	  // Refresh My Uploads Page
	  uploadApi.indexAll().then(indexAllSuccess).catch(indexAllFail);
	};

	var deleteUploadFail = function deleteUploadFail() {
	  $('#message').html('Error on delete');
	};

	var updateUploadSuccess = function updateUploadSuccess(data) {
	  $('#message').html('upload successfully updated!');
	  // Refresh My Uploads Page
	  uploadApi.indexAll().then(indexAllSuccess).catch(indexAllFail);
	};

	var updateUploadFail = function updateUploadFail() {
	  $('#message').html('Error on update');
	};

	var ShowGallerySuccess = function ShowGallerySuccess(data) {
	  $('#photo-grid').html(pageShow({ uploads: data.uploads }));
	  activateLink('.pageShowz');
	};

	var ShowGalleryFail = function ShowGalleryFail() {
	  $('#message').html('error');
	};
	...
	module.exports = {
	  success: success,
	  error: error,
	  indexAllSuccess: indexAllSuccess,
	  indexAllFail: indexAllFail,
	  deleteUploadSuccess: deleteUploadSuccess,
	  deleteUploadFail: deleteUploadFail,
	  updateUploadSuccess: updateUploadSuccess,
	  updateUploadFail: updateUploadFail,
	  ShowGallerySuccess: ShowGallerySuccess,
	  ShowGalleryFail: ShowGalleryFail,
	  onDelete: onDelete,
	  onUpdate: onUpdate
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "            <!-- trigger isUser Helper to check if owner is current user -->\n"
	    + ((stack1 = __default(__webpack_require__(35)).call(depth0 != null ? depth0 : (container.nullContext || {}),blockParams[0][0],{"name":"isUser","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.lambda, alias3=container.escapeExpression;

	  return "                <div class=\"col-md-4\">\n                    <div class=\"thumbnail\">\n\n                        <!-- pic display -->\n                        <div class=\"pic-display\">\n                          "
	    + ((stack1 = __default(__webpack_require__(36)).call(alias1,blockParams[1][0],{"name":"fileType","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n                          <div class='info-overlay clearfix'>\n                                <b>"
	    + alias3(alias2(((stack1 = blockParams[1][0]) != null ? stack1.title : stack1), depth0))
	    + "</b> by: "
	    + alias3(alias2(((stack1 = ((stack1 = blockParams[1][0]) != null ? stack1._owner : stack1)) != null ? stack1.email : stack1), depth0))
	    + " </br>\n                                created: "
	    + ((stack1 = __default(__webpack_require__(37)).call(alias1,((stack1 = blockParams[1][0]) != null ? stack1.updatedAt : stack1),{"name":"formatDate","hash":{},"fn":container.program(5, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n                          </div>\n                        </div>\n                        <div class='upload-actions'\n                          <!-- pic delete button -->\n                          <!-- <div class=\"upload-action pic-del-button\"> -->\n                            <button data-id=\""
	    + alias3(alias2(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"delete-upload btn btn-danger\">Delete</button>\n                          <!-- </div> -->\n\n                          <!-- pic update button -->\n                          <!-- <div class=\"upload-action pic-upload-button\"> -->\n                            <button class=\"update-form-button btn btn-success\">Update Title</button>\n                            <br>\n                            <form data-id=\""
	    + alias3(alias2(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"update-form hidden\">\n                              <fieldset>\n                                <input maxlength=\"20\" type=\"text\" name=\"upload[title]\" placeholder=\"Enter new title here\">\n                                <br>\n                                <button class=\"update-upload btn btn-warning\" type=\"submit\">Submit</button>\n                              </fieldset>\n                            </form>\n                          <!-- </div> -->\n                        </div>\n\n\n                        <!-- pic title -->\n\n                    </div>\n                </div>\n";
	  ...
	  return "\n    <div class=\"container\">\n        <div class=\"row\">\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.uploads : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n\n        </div>\n      </div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isUser = function isUser(upload, options) {
	  // set owner based on upload _owner.id
	  var ownerId = upload._owner.id;
...
/***/ (function(module, exports) {
	...
	var fileType = function fileType(upload, options) {
	  ...
	  if (upload.file_type) {
	    if (upload.file_type.split('/').indexOf('image') > -1) {
	      ...
	      var file = upload.file_type.split('/')[1];
	      if (fileTypes[file]) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "                <div class=\"col-md-4\">\n                    <div class=\"thumbnail\">\n                        <!-- pic display -->\n                        <div class=\"pic-display\">\n                              "
	    + ((stack1 = __default(__webpack_require__(36)).call(depth0 != null ? depth0 : (container.nullContext || {}),blockParams[0][0],{"name":"fileType","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n                              <div class='info-overlay'>\n                                <b><a target=\"_blank\" href=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    + "\">View File</a></b>\n                                  <p><span><b>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</b></span> by: "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1)) != null ? stack1.email : stack1), depth0))
	    + " </br>\n                                </p>\n                              </div>\n                        </div>\n                    </div>\n                </div>\n";
